---
title: "Vaulx Configuration Reference"
sidebarTitle: "Configuration"
description: "Complete reference for all environment variables, session settings, storage configuration, and rate limits used by Vaulx."
---
...
| `SEED_ADMIN_EMAIL` | Yes | — | Email for the admin account seeded on first boot |
