---
title: "Vaulx Trash Panel: Soft Delete and File Restoration"
sidebarTitle: "Trash"
description: "Browse soft-deleted files in the Vaulx admin trash panel, restore files to active status, or permanently delete them from S3 and the database."
---
