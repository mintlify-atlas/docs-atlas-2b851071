---
title: "Managing Users in Vaulx"
sidebarTitle: "User Management"
description: "Create, update, and deactivate user accounts and manage roles from the admin-only user panel in Vaulx."
---
...
<Note>
  `SEED_ADMIN_PASSWORD` must be at least 8 characters and contain at least one digit. Change this value before exposing Vaulx publicly.
</Note>
...
<ParamField body="password" type="string" required>
  Plain-text password hashed with bcrypt `DefaultCost` before storage. Minimum 8 characters recommended.
</ParamField>
