---
title: "Searching Files and Previewing Assets Inline in Vaulx"
sidebarTitle: "Search & Preview"
description: "Search active files and folders by name in Vaulx, and preview images inline using 5-minute presigned S3 URLs — no full page reload required."
---
...
<CardGroup cols={2}>
  ...
  <Card title="Soft Delete & Trash" icon="trash" href="/features/files-and-folders">
