---
title: "ZIP Download API Endpoints"
sidebarTitle: "ZIP"
description: "Streaming and async background ZIP download for authenticated folder trees and public folder shares, with smart job reuse when folder contents haven't changed."
---
